...
class UITree extends Component {
  static propTypes = {
    ...
    // https://github.com/pqx/react-ui-tree/pull/54/files
  ...
  dragStart = (id, dom, e) => {
    ...
    // https://github.com/pqx/react-ui-tree/pull/45/files
  ...
  change = tree => {
    ...
    if (this.props.onChange 
      ...
      // https://github.com/pqx/react-ui-tree/pull/45/files
      && this._dragChanged) this.props.onChange(tree.obj);
  };
  ...
  toggleCollapse = nodeId => {
    ...
    // https://github.com/pqx/react-ui-tree/pull/62
